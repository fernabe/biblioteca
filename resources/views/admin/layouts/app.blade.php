                    ...
                    @if (Auth::guard('web_admin')->user())
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                              aria-expanded="false">
                                {{ Auth::guard('web_admin')->user()->nombre }} <span class="caret"></span>
                            </a>

                            <ul class="dropdown-menu" role="menu">

                                @if ( Auth::guard('web_admin')->user()->tipo == 'super')
                                    <li data-toggle="modal" data-target="#crear-admin">
                                        <a href="#">
                                            <span class="glyphicon glyphicon-user"></span> Crear Administrador
                                        </a>
                                    </li>
                                @endif
                                <li>
